        ...
        <div className='flex flex-col justify-center items-center text-center my-20'>
            ...
            <div className='flex flex-wrap justify-center mt-16 gap-3'>
                {Array(6).fill('').map((item, index) => (                                 // map function to create an array of 6 items and show 6 images
                    <img className='rounded hover:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10' src={index%2 == 0 ? assets.sample_img_1 : assets.sample_img_2 } alt='' key={index} width={70}></img> // On alternate indices, show different images. by checking if index is even or odd by divisibility by 2
                    ))
                }
            </div>
